...
class ArchiviazioneCardLayout extends StatefulWidget {
  ArchiviazioneCardLayout({Key? key, required this.chating}) : super(key: key);
  final ContactLIstUserDataMessage chating;

  @override
  State<ArchiviazioneCardLayout> createState() =>
      _ArchiviazioneCardLayoutState();
}
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        Get.to(ContactListAdminChatingOneToOne(
          user: widget.chating.sender,
        ));
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      MaterialButton(
                        ...
                        color:
                            istrue ? IColor.grey_color : IColor.mainBlueColor,
