...
import 'package:influencer/admin_module/FireBaseUsers/admin_single_chat_user_list_view.dart';
...
import '../admin_module/contactti/view/widget/admin_input_chat_view.dart';
import '../admin_module/contactti/view/widget/new_channel.dart';
import '../admin_module/setting/user_setting.dart';
import '../admin_module/two_way_channel/view/widgets/admin_group_input_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    //  ---------------------------------------
    GetPage(
        name: Paths.fireBaseUsersView,
        page: () => FireBaseUsersView(),
        transition: Transition.fadeIn),
    ...
    // user pages--------------------------------------
    GetPage(
        name: Paths.userCanaliView,
        page: () => UserCanaliView(),
        transition: Transition.fadeIn),
    GetPage(
        name: Paths.userChatView,
        page: () => UserChatView(),
        transition: Transition.fadeIn),
    GetPage(
        name: Paths.userInputChatView,
        page: () => UserInputChatView(),
        transition: Transition.fadeIn),
    GetPage(
